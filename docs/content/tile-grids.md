...
| key               | default  | meaning                                                                                                                                                                                                                                                                                                                                                                                    |
|-------------------|----------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `crs`             | required | The grid's coordinate reference system as `AUTHORITY:CODE`, or `simple` for plain planar units (see [Non-geographic grids](#non-geographic-grids)). `EPSG` codes need nothing else. Any other authority must exist in the database's `spatial_ref_sys` table under that `auth_name` and `auth_srid` (see [Non-EPSG coordinate reference systems](#non-epsg-coordinate-reference-systems)). |
| `origin`          | required | The top-left corner `[x, y]` of the zoom-0 tile, in CRS units.                                                                                                                                                                                                                                                                                                                             |
| `extent_at_zoom0` | required | The side of one zoom-0 tile, in CRS units.                                                                                                                                                                                                                                                                                                                                                 |
| `matrix_at_zoom0` | `[1, 1]` | How many tile `[columns, rows]` zoom 0 has.                                                                                                                                                                                                                                                                                                                                                |

`WorldCRS84Quad` and most planetary geographic grids are `[2, 1]` at zoom 0, the OGC UTM quads are `[1, 2]`. A grid that is two by two at zoom 0 is one by one at zoom 1, so start counting there instead.
